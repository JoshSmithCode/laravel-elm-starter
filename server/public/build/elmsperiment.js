...
var _user$project$Msg$DoStuff = {ctor: 'DoStuff'};
	...
	function (maybeRoute, model) {
		...
		if (_p0.ctor === 'Nothing') {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{activePage: _user$project$Page$NotFound}),
				{ctor: '[]'});
		} else {
			return A2(
				_elm_lang$core$Platform_Cmd_ops['!'],
				_elm_lang$core$Native_Utils.update(
					model,
					{activePage: _user$project$Page$Home}),
				{ctor: '[]'});
		}
	});
...
var _user$project$Main$main = A2(
	...
	{init: _user$project$Main$init, view: _user$project$Main$view, update: _user$project$Update$update, subscriptions: _user$project$Main$subscriptions})(_elm_lang$core$Json_Decode$value);

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Msg.Msg","aliases":{},"unions":{"Msg.Msg":{"tags":{"SetRoute":["Maybe.Maybe Route.Route"],"DoStuff":[]},"args":[]},"Maybe.Maybe":{"tags":{"Nothing":[],"Just":["a"]},"args":["a"]},"Route.Route":{"tags":{"Home":[]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
